...
if(isset($_POST['submit'])) {
    ...
    $checkqsn = "SELECT * FROM htmlquestions";
	$runcheck = mysqli_query($conn , $checkqsn) or die(mysqli_error($conn));
	$qno = mysqli_num_rows($runcheck) + 1;

	$query = "INSERT INTO htmlquestions(qno, question , ans1, ans2, ans3, ans4, correct_answer) VALUES ('$qno' , '$question' , '$choice1' , '$choice2' , '$choice3' , '$choice4' , '$correct_answer') " ;
...
<html>
	...
	<div class="modal">
			<h2 style="text-align: center; padding:15px">Add a HTML Question</h2>
